...
if(isset($_POST['form_gonder']))
{
    ...
    $guncelle = "UPDATE kerkukonemi SET baslik = '$baslik', metin1 = '$metin1', metin2 = '$metin2'WHERE id = $duzenlenecek_id;";
...
if(isset($_POST['veri'])){
    header("Location: veri_listeleme_kerkuk.php");
}

$sql="SELECT * FROM kerkukonemi WHERE `id`=$id;";
