...
$islem = $_GET["islem"];
    ...
    if ($islem== "ekle") {
        ...
        $metin2 = $_POST["metin2"];
        $id = $_POST["id"];
        $sorgu = $baglan->query("INSERT INTO kerkukonemi (baslik, metin1, metin2) VALUES ('$baslik', '$metin1', '$metin2')");      
        echo "<script> window.location.href='veri_listeleme_kerkuk.php'; </script>";
    }
...
--<a href="veri_listeleme_kerkuk.php">KERKÜK ÖNEMİ</a>-<a href="cikis.php" onclick="if(!confirm('çıkış yapmak istediğinize emin misiniz'))return false;">ÇIKIŞ</a>
        ...
        <form action="veri_listeleme_kerkuk.php?islem=ekle" enctype="multipart/form-data" method="post">
    ...
    <div style="margin-bottom:20px;  padding: 20px; border: 2px solid red;">
        <table>
            ...
            while($satir = $sonuc->fetch_assoc())
            {
                ...
                echo '<td>';
                echo '<a href="duzenle_kerkuk.php?id='.$satir['id'].'" onclick="closeCurrentTab()">Düzenle</a>&nbsp;&nbsp; ';    
                echo ' <a href="sil_kerkuk.php?id='.$satir['id'].'" onclick="closeCurrentTab()">Sil</a>';
                echo '</td>';
                echo '</tr>';
            }
            ?>
